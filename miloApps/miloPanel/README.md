...
AppImages generated by miloPKG carry the same AppMenu environment in their
`AppRun`. The panel also allows a longer registration window for these mounted
applications and resolves their locally registered desktop identity.
