...
xfconf-query -c xfwm4 -p /general/theme -s miloOS
xfconf-query -c xsettings -p /Net/ThemeName -s miloOS
...
xfconf-query -c xsettings -p /Gtk/CursorThemeName -s Luna
xfconf-query -c xfce4-desktop -p /backdrop/screen0/monitor0/workspace0/last-image -s /usr/share/backgrounds/blue-mountain.jpg
